...
DATASTORE_TYPE_VVOL = 'VVOL'

DEFAULT_VIF_MODEL = network_model.VIF_MODEL_E1000E
...
DRS_BEHAVIOR_FULLY_AUTOMATED = 'fullyAutomated'
DRS_BEHAVIOR_PARTIALLY_AUTOMATED = 'partiallyAutomated'

DAS_RESTART_PRIORITY_HIGH = 'high'
