...
class ComputeVolumeTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.stub_out(
            'nova.db.main.api.block_device_mapping_create', store_cinfo)
        self.stub_out(
            'nova.db.main.api.block_device_mapping_update', store_cinfo)
...
class ComputeTestCase(BaseTestCase,
    ...
    def _test_reboot(self, soft, mock_notify_action, mock_get_power,
                     ...
                     mock_get_blk, mock_get_bdms, mock_shares,
                     mock_del_stale_bdms,
                     test_delete=False, test_unrescue=False, fail_reboot=False,
                     fail_running=False):
        mock_shares.return_value = objects.ShareMappingList()
        ...
        expected_call_info = {
            ...
            'kwargs': {'block_device_info': fake_block_dev_info,
                       'accel_info': [],
                       'share_info': mock_shares.return_value}}
    ...
    def _test_reboot_with_accels(self, mock_notify_action, mock_get_power,
             ...
             mock_shares, mock_del_stale_bdms,
    ...
    def test_soft_reboot_with_share_info(
        ...
        mock_mount_all.assert_not_called()
    ...
    def test_hard_reboot_with_share_info(
        ...
        mock_mount_all.assert_called_once_with(mock.ANY, instance, share_info)
    ...
    def test_hard_reboot_with_share_info_error(
        ...
        mock_mount_all.assert_called_once_with(
            mock.ANY, instance, share_info)
    ...
    def test_add_instance_fault(self):
        ...
        self.stub_out('nova.db.main.api.instance_fault_create',
    ...
    def _heal_instance_info_cache(self,
        ...
        self.stub_out('nova.db.main.api.instance_get_all_by_host',
    ...
    def test_poll_unconfirmed_resizes(self):
        ...
        self.stub_out(
            'nova.db.main.api.instance_get_by_uuid', fake_instance_get_by_uuid)
        self.stub_out(
            'nova.db.main.api.migration_get_unconfirmed_by_dest_compute',
            fake_migration_get_unconfirmed_by_dest_compute)
        self.stub_out(
            'nova.db.main.api.migration_update', fake_migration_update)
        self.stub_out(
            'nova.compute.api.API.confirm_resize', fake_confirm_resize)
...
class ComputeAPITestCase(BaseTestCase):
    ...
    @mock.patch("nova.db.main.api.migration_get_by_id_and_instance")
